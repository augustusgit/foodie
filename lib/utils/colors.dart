...
// Light Theme Colors
const appColorPrimary = Color(0xFFFE724C);//Color(0xFFFFA500);
const appColorPrimaryDark = Color(0xFF000000);
const appColorAccent = Color(0xFFFF3939);//Color(0xFFE39403);
const appTextColorPrimary = Color(0xFF323643);
const iconColorPrimary = Color(0xFF4285F4);
...
const cardBackgroundBlackDark = Color(0xFFFFA500);
